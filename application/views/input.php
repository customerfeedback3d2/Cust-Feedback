    ...
    <div class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          <a href="<?php echo base_url() ;?>/" class="navbar-brand">SCUSTOMER EXPERIENCE SURVEY FIDIFARA</a>
    ...
    <div class="container">
          ...
          <div class="col-lg-12">
            ...
            <div class="col-lg-12">
              ...
              <div class="form-group">
            <label for="inputEmail" class="col-lg-2">No. Telp</label>
            <div class="col-lg-12">
            ...
            <div class="col-lg-12">
              ...
              <div class="form-group">
            <label for="inputEmail" class="col-lg-2">Kode</label>
            <div class="col-lg-12">
           ...
           <?php
            ...
            ?>
            <div class="form-group">
            <label for="inputEmail" class="col-lg-2">saran</label>
            <div class="col-lg-12">
